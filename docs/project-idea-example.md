...
A typical user might start their day by searching for "meeting summary" from the home page to find their template for summarizing client calls. After customizing it for today's specific meeting, they might navigate to their writing folder to grab a prompt for a blog post they're working on. Later, they might browse through their work-related folders to find prompts related to data analysis for a project presentation.
